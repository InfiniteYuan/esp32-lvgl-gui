...
// Commands list copied from https://github.com/adafruit/Adafruit-ST7789-Library
#define DELAY 0x80
    ...
    case GDISP_CONTROL_ORIENTATION:
        ...
        switch((orientation_t)g->p.ptr) {
            case GDISP_ROTATE_0:
                ...
                write_data_byte(g, 0xC0|ST7789_MADCTRL_COLOR);
                g->g.Height = GDISP_SCREEN_HEIGHT;
                g->g.Width = GDISP_SCREEN_WIDTH;
                release_bus(g);
                break;
            case GDISP_ROTATE_90:
                acquire_bus(g);
                write_cmd(g, ST7789_MADCTL);
                write_data_byte(g, 0xA0|ST7789_MADCTRL_COLOR);
            ...
            case GDISP_ROTATE_180:
                acquire_bus(g);
                write_cmd(g, ST7789_MADCTL);
                write_data_byte(g, 0x00|ST7789_MADCTRL_COLOR);
                g->g.Height = GDISP_SCREEN_HEIGHT;
                g->g.Width = GDISP_SCREEN_WIDTH;
                release_bus(g);
                break;
            case GDISP_ROTATE_270:
                acquire_bus(g);
                write_cmd(g, ST7789_MADCTL);
                write_data_byte(g, 0x60|ST7789_MADCTRL_COLOR);
                g->g.Height = GDISP_SCREEN_WIDTH;
                g->g.Width = GDISP_SCREEN_HEIGHT;
                release_bus(g);
                break;
